...
def save_predicted_pdb_with_sidechain_map(name, predicted_sidechain_coords, prot_res_mask,
    ...
    try:
        ...
        pred_coords_np = predicted_sidechain_coords.detach().cpu().numpy()
        prot_mask_np = prot_res_mask.detach().cpu().numpy()
        sidechain_mask_np = sidechain_atom_mask.detach().cpu().numpy()
