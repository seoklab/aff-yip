...
from .utils import (
    stack_bb_coordinates, get_residue_dihedrals, get_sidechain_orientation,get_sidechain_info,
...
class ProteinFeaturizer:
    ...
    def featurize_graph_wo_virtual_nodes(
        ...
        X_res_all, residue_s = stack_bb_coordinates(protein_wo_water) # this already excludes water
        # sidechain_map = protein_wo_water.get_sidechain_info()
        sidechain_map = get_sidechain_info(residue_s)
        # ca atoms
    ...
    def featurize_graph_with_virtual_nodes(
        ...
        X_res_all, residue_s = stack_bb_coordinates(protein_wo_water) 
        # ca atoms
        X_res_ca = X_res_all[1::3]  # assuming every 3rd atom is CA
    ...
    def featurize_graph_basic(
        ...
        X_res_all = stack_bb_coordinates(protein_wo_water) # this already excludes water
